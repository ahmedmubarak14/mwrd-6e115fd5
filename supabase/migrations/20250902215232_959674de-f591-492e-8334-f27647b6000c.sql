-- Create sample client and vendor users
DO $$
DECLARE
...
BEGIN
  ...
  INSERT INTO user_profiles (user_id, email, full_name, role, company_name, phone, location, status, verification_status, created_at, updated_at) VALUES
  ...
  INSERT INTO user_profiles (user_id, email, full_name, role, company_name, phone, location, categories, rating, status, verification_status, created_at, updated_at) VALUES
  (vendor1_id, 'vendor1@mwrd.com', 'Omar Construction Co.', 'vendor', 'Omar Elite Builders', '+966502234001', 'Riyadh, Saudi Arabia', ARRAY[construction_cat_id::text, residential_sub_id::text], 4.8, 'approved', 'approved', now(), now()),
  (vendor2_id, 'vendor2@mwrd.com', 'Nadia Engineering', 'vendor', 'Advanced Engineering Solutions', '+966502234002', 'Jeddah, Saudi Arabia', ARRAY[engineering_cat_id::text], 4.6, 'approved', 'approved', now(), now()),
  (vendor3_id, 'vendor3@mwrd.com', 'TechPro Arabia', 'vendor', 'TechPro Software Development', '+966502234003', 'Riyadh, Saudi Arabia', ARRAY[technology_cat_id::text, software_sub_id::text], 4.9, 'approved', 'approved', now(), now()),
  (vendor4_id, 'vendor4@mwrd.com', 'Gulf Contractors', 'vendor', 'Gulf Commercial Builders', '+966502234004', 'Dammam, Saudi Arabia', ARRAY[construction_cat_id::text, commercial_sub_id::text], 4.4, 'approved', 'approved', now(), now()),
  (vendor5_id, 'vendor5@mwrd.com', 'Digital Solutions KSA', 'vendor', 'Digital Transformation Experts', '+966502234005', 'Jeddah, Saudi Arabia', ARRAY[technology_cat_id::text], 4.7, 'approved', 'approved', now(), now());
