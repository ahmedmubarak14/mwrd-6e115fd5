...
const translations = {
  en: {
    ...
    'settings.profileInfoDesc': 'Update your personal information and contact details',
  ...
  ar: {
    ...
    'settings.profileInfoDesc': 'تحديث معلوماتك الشخصية وتفاصيل الاتصال',
    ...
    'analytics.totalRequests': 'إجمالي الطلبات',
    'analytics.activeOffers': 'العروض النشطة',
