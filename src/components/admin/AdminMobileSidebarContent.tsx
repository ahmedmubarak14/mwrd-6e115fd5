          ...
          {navigation.map((item) => {
            ...
            return (
              <Button
                ...
                className={cn(
                  "w-full justify-start h-14 text-base transition-all duration-300 group relative overflow-hidden",
              ...
              >
                <Link 
                  to={item.href} 
                  className="flex items-center gap-4 px-4 w-full z-10"
                  onClick={onItemClick}
                >
                  ...
                  <span className="flex-1 truncate transition-all duration-300">{item.name}</span>
                  {item.badge && (
                    <Badge 
                      variant={item.badgeVariant || "secondary"} 
                      className={cn(
                        "h-6 w-6 p-0 text-xs flex-shrink-0 transition-all duration-300",
