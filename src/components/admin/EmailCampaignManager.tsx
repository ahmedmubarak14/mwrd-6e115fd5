        ...
        <TabsContent value="campaigns" className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('admin.email.totalCampaigns')}</CardTitle>
              <Mail className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{campaignStats?.total || 0}</div>
              <p className="text-xs text-muted-foreground">{t('admin.email.allTime')}</p>
            </CardContent>
            </Card>

            <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('admin.email.sentThisMonth')}</CardTitle>
              <Send className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-success">{campaignStats?.sentThisMonth || 0}</div>
              <p className="text-xs text-muted-foreground">{t('admin.email.monthlyGrowth')}</p>
            </CardContent>
            </Card>

            <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('admin.email.openRate')}</CardTitle>
              <Eye className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-info">{campaignStats?.openRate || 0}%</div>
              <p className="text-xs text-muted-foreground">{t('admin.email.average')}</p>
            </CardContent>
            </Card>

            <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('admin.email.clickRate')}</CardTitle>
            ...
            {isLoading ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-lg font-medium mb-2">{t('admin.email.noCampaignsYet')}</p>
                  <p className="text-muted-foreground">{t('admin.email.createFirstCampaign')}</p>
                </CardContent>
              </Card>
            ) : (
