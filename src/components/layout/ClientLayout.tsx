...
export const ClientLayout = ({ children }: ClientLayoutProps) => {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(() => {
    const saved = localStorage.getItem('clientSidebarOpen');
      ...
      <MobileContainer pageType="dashboard" className="min-h-screen">
        {isMobile ? (
          ...
          <div className="min-h-screen flex flex-col">
            <ClientHeader onMobileMenuOpen={() => setMobileMenuOpen(true)} />
            <ClientMobileSidebar 
            ...
            >
              <ClientHeader 
                onSidebarToggle={() => {
                  ...
                  localStorage.setItem('clientSidebarOpen', JSON.stringify(newState));
                }}
