export const enUS = {
  ...
  admin: {
    ...
    financial: {
      ...
      transactionsDescription: 'Manage and monitor platform financial transactions',
      amount: 'Amount',
      type: 'Type',
      ...
      monitorRevenue: 'Monitor platform revenue and transaction metrics',
      growthFromPeriod: 'from previous period',
