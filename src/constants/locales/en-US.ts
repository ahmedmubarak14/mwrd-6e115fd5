export const enUS = {
  ...
  admin: {
    ...
    kyc: {
      ...
      warningCRMissing: "Warning: CR document file is missing from storage",
      warningVATMissing: "Warning: VAT document file is missing from storage",
      warningAddressMissing: "Warning: Address document file is missing from storage",
      ...
      approveSuccessDesc: "The KYC submission has been approved successfully",
      rejectSuccess: "KYC Rejected",
      rejectSuccessDesc: "The KYC submission has been rejected",
      ...
      reviewNotesRequiredDesc: "Please provide review notes when rejecting a submission",
      fetchError: "Error",
