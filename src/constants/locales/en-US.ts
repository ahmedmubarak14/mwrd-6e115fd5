...
export const enUS = {
  ...
  vendor: {
    ...
    subscription: {
      ...
      error: "Error",
      failedUpgrade: "Failed to initiate upgrade",
      expiresIn: "Your subscription expires in {days} days. Renew now to avoid interruption.",
    ...
    transactions: {
      ...
      description: "Track all your financial transactions and payments",
      totalRevenue: "Total Revenue",
      totalExpenses: "Total Expenses",
      pendingAmount: "Pending Amount",
      netProfit: "Net Profit",
      recentTransactions: "Recent Transactions",
      completeHistory: "Your complete transaction history",
      ...
      errorFetch: "Failed to fetch transaction history"
    },
    rfqsPage: {
      title: "RFQ Management",
      description: "Browse available RFQs and manage your bids",
      availableRFQs: "Available RFQs",
      myBids: "My Bids",
      ...
      availableRFQsTab: "Available RFQs",
      myBidsTab: "My Bids",
      browseAndBid: "Browse and bid on active RFQs",
      searchRFQs: "Search RFQs...",
      published: "Published",
      inProgress: "In Progress",
      daysLeft: "days left",
      ...
      trackStatus: "Track the status of your submitted bids",
      bidAmount: "Bid Amount",
      delivery: "Delivery",
      submitted: "Submitted",
      noRFQsFound: "No RFQs found matching your criteria",
      noBidsYet: "You haven't submitted any bids yet",
      bidSubmissionTitle: "Bid Submission",
      openingForm: "Opening bid submission form...",
      errorFetchRFQs: "Failed to fetch RFQs",
      errorFetchBids: "Failed to fetch your bids"
    },
    notifications: {
      title: "Notifications",
      ...
      allNotificationsTab: "All Notifications",
      unreadTab: "Unread ({count})",
      settings: "Settings",
      completeHistory: "Your complete notification history",
      needAttention: "Notifications that need your attention",
      configurePreferences: "Configure how you receive notifications",
      ...
      newRFQs: "New RFQs",
      newRFQsDesc: "When new RFQs match your profile",
      bidUpdates: "Bid Updates",
      bidUpdatesDesc: "Status updates on your bids",
      paymentAlerts: "Payment Alerts",
      paymentAlertsDesc: "Payment confirmations and reminders",
      messages: "Messages",
      messagesDesc: "New messages from clients",
      systemUpdates: "System Updates",
      systemUpdatesDesc: "Platform updates and maintenance",
      noNotifications: "No notifications yet",
      noUnread: "No unread notifications",
      settingsUpdated: "Settings updated",
      preferencesUpdated: "Your notification preferences have been saved",
      success: "Success",
      allMarkedRead: "All notifications marked as read",
      errorMarkingRead: "Failed to mark notifications as read",
      errorFetch: "Failed to fetch notifications"
    },
    clients: {
      title: "Client Relationships",
      description: "Manage your client relationships and interaction history",
      totalClients: "Total Clients",
      activeClients: "Active Clients",
      totalRevenue: "Total Revenue",
      avgOrderValue: "Avg Order Value",
      allRelationships: "All client relationships",
      withCompletedOrders: "With completed orders",
      fromAllClients: "From all clients",
      perOrderAverage: "Per order average",
      clientDirectory: "Client Directory",
      completeOverview: "Your complete client relationship overview",
      ...
      noRelationships: "No client relationships yet",
      errorFetch: "Failed to fetch client data"
    },
    documents: {
      title: "Document Center",
      description: "Manage all your business documents and files",
      ...
      allUploaded: "All your uploaded documents and files",
      ...
      bidDocumentsDesc: "Documents attached to your bid submissions",
      project: "Project",
      bidFor: "Bid for",
      ...
      errorFetch: "Failed to fetch documents"
    },
    reports: {
      ...
      dailyRevenue: "Daily revenue over the selected period",
      orderVolume: "Order Volume",
      ordersPerDay: "Number of orders per day",
      bidStatusDistribution: "Bid Status Distribution",
      bidStatusBreakdown: "Breakdown of your bid statuses",
      topClientsByRevenue: "Top Clients by Revenue",
      valuableRelationships: "Your most valuable client relationships",
      avgLabel: "avg",
      ...
      errorFetch: "Failed to fetch report data"
    }
  },
  common: {
    errors: {
  ...
  vendor: {
    ...
    cr: {
      ...
      completeVerification: "Complete CR verification to unlock all features",
      pending: "Pending",
      approved: "Approved",
      rejected: "Rejected"
    },
    documents: {
      title: "Documents",
      description: "Manage and view all your uploaded documents and files",
      totalDocuments: "Total Documents",
      rfqDocuments: "RFQ Documents", 
      bidDocuments: "Bid Documents",
      storageUsed: "Storage Used",
      ...
      totalSize: "Total size",
      documentLibrary: "Document Library",
      documentLibraryDesc: "All your uploaded documents and files",
      uploadDocument: "Upload Document",
      searchDocuments: "Search documents...",
      allCategories: "All Categories",
      allTypes: "All Types",
      ...
      rfqDocs: "RFQ Docs",
      bidDocs: "Bid Docs",
      rfqDocsTitle: "RFQ Documents",
      rfqDocsDesc: "Documents related to RFQ submissions",
      bidDocsTitle: "Bid Documents",
      bidDocsDesc: "Documents attached to your bid submissions",
      projectLabel: "Project:",
      bidForLabel: "Bid for:",
      noDocumentsSearch: "No documents found matching your search",
      noDocumentsYet: "No documents uploaded yet",
    ...
    reports: {
      ...
      description: "Comprehensive business performance analytics and insights",
      totalRevenue: "Total Revenue",
      winRate: "Win Rate",
      avgOrderValue: "Avg Order Value", 
      activeClients: "Active Clients",
      fromOrders: "From {count} orders",
      bidsCount: "{won} of {total} bids",
      averagePerOrder: "Average per order",
      uniquePayingClients: "Unique paying clients",
      last7Days: "Last 7 days",
      last30Days: "Last 30 days",
      ...
      orderVolume: "Order Volume",
      orderVolumeDesc: "Number of orders per day",
      bidStatusDistribution: "Bid Status Distribution", 
      bidStatusDesc: "Breakdown of your bid statuses",
      topClientsByRevenue: "Top Clients by Revenue",
      topClientsDesc: "Your most valuable client relationships",
      ordersLabel: "orders",
      avgLabel: "avg",
      noClientData: "No client data available for the selected period",
      ...
      keyInsights: "Key Insights",
      topPerformingCategory: "Top Performing Category",
