export const arSA = {
  ...
  products: {
    ...
    catalogDesc: 'إدارة مخزون المنتجات وعرض عروضك',
    ...
    noMatchingProducts: 'لا توجد منتجات تطابق المرشحات الحالية',
    ...
    subcategoryPlaceholder: 'فئة فرعية اختيارية',
    ...
    unit: 'الوحدة',
    unitPlaceholder: 'مثل: قطعة، كيلو، متر',
    sku: 'رمز المنتج',
    ...
    warranty: 'الضمان (شهور)',
    deliveryTime: 'وقت التسليم (أيام)',
    images: 'صور المنتج',
    uploadImages: 'رفع الصور',
    features: 'المميزات',
    addFeature: 'إضافة ميزة',
    featurePlaceholder: 'أدخل ميزة المنتج',
    tags: 'العلامات',
    addTag: 'إضافة علامة',
    tagPlaceholder: 'أدخل علامة',
    specifications: 'المواصفات',
    propertiesSettings: 'الخصائص والإعدادات',
    featuredProduct: 'منتج مميز',
    isFeatured: 'تمييز كمنتج مميز',
    save: 'حفظ المنتج',
    cancel: 'إلغاء',
    saving: 'جاري الحفظ...',
    // الرسائل
