    ...
    subscription: {
      ...
      plans: {
        basic: {
          name: "أساسي",
          price: "19$ شهرياً",
          features: ["5 عروض أسعار شهرياً", "تحليلات أساسية", "دعم بالبريد الإلكتروني"]
        },
        premium: {
          name: "متميز",
          price: "49$ شهرياً", 
          features: ["عروض أسعار غير محدودة", "تحليلات متقدمة", "دعم أولوية", "قوائم مميزة"]
        },
        enterprise: {
          name: "المؤسسات",
          price: "99$ شهرياً",
          features: ["كل شيء في المتميز", "تكامل مخصص", "دعم مخصص", "خيارات العلامة البيضاء"]
        }
      }
    },
    transactions: {
