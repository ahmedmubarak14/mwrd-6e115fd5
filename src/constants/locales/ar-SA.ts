export const arSA = {
  ...
  common: {
    ...
    verification: {
      ...
      crDocumentTitle: 'وثيقة السجل التجاري',
      crDocumentDescription: 'ارفع شهادة السجل التجاري (CR) لشركتك. الصيغ المقبولة: PDF، JPEG، PNG (الحد الأقصى 10 ميجابايت)',
      documentUploaded: 'تم رفع وثيقة السجل التجاري وهي قيد المراجعة.',
      reupload: 'إعادة الرفع',
      uploadCRButton: 'رفع السجل التجاري',
      crVerificationRequired: 'التحقق من السجل التجاري مطلوب للوصول إلى إنشاء طلبات التسعير وتقديم الطلبات والتفاعل مع البائعين.',
      loginRequired: 'يجب تسجيل الدخول لرفع الوثائق',
      uploadFailed: 'فشل في رفع الوثيقة',
