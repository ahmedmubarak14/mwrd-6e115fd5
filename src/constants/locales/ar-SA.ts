export const arSA = {
  ...
  admin: {
    ...
    kyc: {
      ...
      warningCRMissing: "تحذير: ملف السجل التجاري مفقود من التخزين",
      warningVATMissing: "تحذير: ملف شهادة الضريبة مفقود من التخزين",
      warningAddressMissing: "تحذير: ملف إثبات العنوان مفقود من التخزين",
      ...
      reviewNotesRequiredDesc: "يرجى تقديم ملاحظات المراجعة عند رفض الطلب",
      fetchError: "خطأ",
