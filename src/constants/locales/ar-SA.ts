export const arSA = {
  ...
  vendor: {
    ...
    transactions: {
      title: "سجل المعاملات",
      subtitle: "عرض سجل المدفوعات والأرباح",
    ...
    clients: {
      ...
      noClientsFound: "لم يتم العثور على عملاء مطابقين للبحث",
      noClientsYet: "لا توجد علاقات عملاء بعد",
      clientName: "اسم العميل",
    ...
    documents: {
      ...
      description: "أدر جميع وثائق مشاريعك والملفات",
      totalDocuments: "إجمالي الوثائق",
      allFiles: "جميع الملفات",
      rfqDocuments: "وثائق طلبات الأسعار",
      ...
      documents: "الوثائق",
      rfqDocs: "وثائق طلبات الأسعار",
      bidDocs: "وثائق العروض",
      documentLibrary: "مكتبة الوثائق",
      allUploaded: "جميع الوثائق والملفات المرفوعة",
      uploadDocument: "رفع وثيقة",
      searchDocuments: "البحث في الوثائق...",
      allCategories: "جميع الفئات",
      allTypes: "جميع الأنواع",
      images: "الصور",
      noDocumentsFound: "لم يتم العثور على وثائق مطابقة للبحث",
      noDocumentsYet: "لم يتم رفع وثائق بعد",
      rfqDocumentsTitle: "وثائق طلبات الأسعار",
      rfqDocumentsDesc: "الوثائق المتعلقة بتقديم طلبات الأسعار",
      bidDocumentsTitle: "وثائق العروض",
      bidDocumentsDesc: "الوثائق المتعلقة بعروضك",
      project: "المشروع:",
      bidFor: "عرض لـ:",
    ...
    reports: {
      ...
      description: "تحليلات شاملة ورؤى الأعمال",
      totalRevenue: "إجمالي الإيرادات",
      winRate: "معدل الفوز",
      bidsCount: "{won} من {total} عروض فائزة",
      ...
      revenueTrendDesc: "تتبع أداء إيراداتك عبر الزمن",
      orderVolume: "حجم الطلبات",
      orderVolumeDesc: "عدد الطلبات المستلمة عبر الزمن",
      bidStatusDistribution: "توزيع حالة العروض",
      bidStatusDesc: "تفصيل نتائج عروضك",
      topClientsByRevenue: "أفضل العملاء حسب الإيرادات",
      topClientsDesc: "علاقات عملائك الأعلى قيمة",
      ordersLabel: "طلبات",
      avgLabel: "متوسط",
