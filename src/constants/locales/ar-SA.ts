export const arSA = {
  ...
  settings: {
    ...
    recentAdminActivity: 'نشاط المدير الأخير',
  ...
  communication: {
    ...
    chats: "المحادثات",
    userEngagementReport: "تقرير تفاعل المستخدمين",
    report: "التقرير",

    // CSV Report Labels
    userEngagementReportTitle: "تقرير تفاعل المستخدمين",
    generated: "تم الإنشاء",
    totalActiveUsers: "إجمالي المستخدمين النشطين",
    totalMessagesLabel: "إجمالي الرسائل",
    averageResponseTimeLabel: "متوسط وقت الاستجابة",
    minutes: "دقائق",
    ...
    settingsError: "خطأ",
    settingsFailedSave: "فشل في حفظ الإعدادات. يرجى المحاولة مرة أخرى.",
    ...
    bounceHandling: "معالجة الرسائل المرتدة",
    bounceHandlingDesc: "معالجة الرسائل المرتدة تلقائياً",
    emailTracking: "تتبع البريد الإلكتروني",
    emailTrackingDesc: "تتبع فتح الرسائل والنقرات",
    unsubscribeLink: "رابط إلغاء الاشتراك",
    unsubscribeLinkDesc: "تضمين رابط إلغاء الاشتراك في الرسائل",
    saveEmailSettings: "حفظ إعدادات البريد الإلكتروني",

    // SMS Configuration
    smsConfiguration: "تكوين رسائل SMS",
    smsConfigDesc: "تكوين مزود SMS وإعدادات التسليم",
    smsProvider: "مزود SMS",
    apiKey: "مفتاح API",
    apiSecret: "سر API",
    apiKeyPlaceholder: "مفتاح API الخاص بك",
    apiSecretPlaceholder: "سر API الخاص بك",
    fromNumber: "رقم المرسل",
    fromNumberPlaceholder: "+1234567890",
    rateLimitPerMinute: "حد المعدل (في الدقيقة)",
    deliveryReports: "تقارير التسليم",
    deliveryReportsDesc: "تتبع حالة تسليم SMS",
    optOutKeywords: "كلمات إلغاء الاشتراك",
    optOutKeywordsDesc: "يمكن للمستخدمين الرد بهذه الكلمات لإلغاء الاشتراك من إشعارات SMS",
    saveSmsSettings: "حفظ إعدادات SMS",

    // Notification Preferences  
    notificationPreferences: "تفضيلات الإشعارات",
    notificationConfigDesc: "تكوين إعدادات الإشعارات العامة وتفضيلات التسليم",
    realTimeNotifications: "الإشعارات في الوقت الفعلي",
    realTimeNotificationsDesc: "إشعارات فورية للأحداث المهمة",
    emailNotifications: "إشعارات البريد الإلكتروني",
    emailNotificationsDesc: "إرسال الإشعارات عبر البريد الإلكتروني",
    smsNotifications: "إشعارات SMS",
    smsNotificationsDesc: "إرسال التنبيهات المهمة عبر SMS",
    ...
    thirdPartyIntegrations: "تكامل الأطراف الثالثة",
    integrationsConfigDesc: "تكوين webhooks وتكامل الخدمات الخارجية",
    ...
    enableWebhookNotifications: "تفعيل إشعارات Webhook",
    enableWebhookNotificationsDesc: "إرسال الإشعارات إلى webhooks المكونة",
  ...
  admin: {
    ...
    bulkRoleConfirm: "هل أنت متأكد من تحديث {count} مستخدم إلى دور {role}؟",
    ...
    bulkStatusConfirm: "هل أنت متأكد من تحديث {count} مستخدم إلى حالة {status}؟",
    ...
    usersActiveAnalytics: "مستخدمون نشطون",
    growthRateAnalytics: "معدل النمو",
    monthlyGrowthAnalytics: "النمو الشهري", 
    conversionRateAnalytics: "معدل التحويل",
    visitorConversionAnalytics: "تحويل الزوار",
    addNewUser: "إضافة مستخدم جديد",
    createUserAccount: "إنشاء حساب مستخدم جديد للمنصة",
    ...
    editUserDescription: "تحديث معلومات حساب المستخدم",
    ...
    addNewUserDescription: "إنشاء حساب مستخدم جديد للمنصة",
