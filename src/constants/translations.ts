export const translations = {
  en: {
    ...
    'admin.requestsApproval': 'Requests Approval',
    'admin.requestsApprovalDesc': 'Review and approve service requests',
    'admin.welcomeBack': 'Welcome back! Here\'s an overview of your platform\'s performance.',
    'admin.keyMetrics': 'Key Business Metrics',
    ...
    'admin.orderLifecycleSupport': 'Order Lifecycle & Support Overview',
    ...
    'admin.allCaughtUp': 'All caught up! No urgent items need attention.',
    ...
    'admin.jumpToKeyFunctions': 'Jump to key admin functions',
    ...
    'admin.errorLoadingStats': 'Failed to load dashboard statistics',
    'common.refresh': 'Refresh',

    // User Management
    'users.management': 'User Management',
    'users.manageDescription': 'Manage users, roles, and verification requests',
    'users.verificationQueue': 'Verification Queue',
    'users.verificationDescription': 'Review and process user verification requests',
  ...
  ar: {
    ...
    'admin.requestsApproval': 'الموافقة على الطلبات',
    'admin.requestsApprovalDesc': 'مراجعة والموافقة على طلبات الخدمة',
    'admin.welcomeBack': 'مرحباً بعودتك! إليك نظرة عامة على أداء منصتك.',
    'admin.keyMetrics': 'المقاييس التجارية الرئيسية',
    'admin.totalClients': 'إجمالي العملاء',
    'admin.activeClientAccounts': 'حسابات العملاء النشطة',
    'admin.totalVendors': 'إجمالي الموردين',
    'admin.registeredVendors': 'الموردين المسجلين',
    'admin.currentlyBeingProcessed': 'قيد المعالجة حالياً',
    'admin.inProgressOrders': 'طلبات قيد التنفيذ',
    'admin.orderLifecycleSupport': 'دورة حياة الطلبات ونظرة عامة على الدعم',
    'admin.completedOrders': 'الطلبات المكتملة',
    'admin.successfullyDelivered': 'تم التسليم بنجاح',
    'admin.awaitingAdminApproval': 'في انتظار موافقة المشرف',
    'admin.requireAttention': 'تتطلب اهتماماً',
    'admin.platformCommissionEarned': 'عمولة المنصة المكتسبة',
    'admin.requiresImmediateAttention': 'يتطلب اهتماماً فورياً',
    'admin.pendingOfferApprovals': 'موافقات العروض المعلقة',
    'admin.offersAwaitingReview': 'عروض تنتظر المراجعة',
    'admin.openSupportTickets': 'تذاكر الدعم المفتوحة',
    'admin.ticketsNeedResponse': 'تذاكر تحتاج لاستجابة',
    'admin.allCaughtUp': 'تم اللحاق بكل شيء! لا توجد عناصر عاجلة تحتاج لاهتمام.',
    ...
    'admin.jumpToKeyFunctions': 'انتقل إلى وظائف الإدارة الرئيسية',
    ...
    'admin.loadingDashboard': 'تحميل لوحة التحكم...',
    'admin.errorLoadingStats': 'فشل في تحميل إحصائيات لوحة التحكم',
    'common.refresh': 'تحديث',

    // User Management - إدارة المستخدمين
    'users.management': 'إدارة المستخدمين',
    'users.manageDescription': 'إدارة المستخدمين والأدوار وطلبات التحقق',
    'users.verificationQueue': 'قائمة انتظار التحقق',
    'users.verificationDescription': 'مراجعة ومعالجة طلبات التحقق من المستخدمين',
