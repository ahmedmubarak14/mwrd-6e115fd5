...
export const translations = {
  en: {
    ...
    'admin.managePlatform': 'Manage your platform, monitor activity, and oversee operations',
    ...
    'admin.platformActivity': 'Platform Activity',
  ...
  ar: {
    ...
    'admin.managePlatform': 'إدارة منصتك ومراقبة النشاط والإشراف على العمليات',
    'admin.newUsers': 'المستخدمين الجدد',
    'admin.thisMonth': 'هذا الشهر',
    'admin.totalRevenue': 'إجمالي الإيرادات',
    'admin.completedProjects': 'المشاريع المكتملة',
    ...
    'admin.platformActivity': 'نشاط المنصة',
