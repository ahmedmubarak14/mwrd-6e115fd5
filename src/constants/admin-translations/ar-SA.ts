...
export const adminTranslationsAR = {
  ...
  pushNotifications: {
    ...
    successfulDeliveries: "التسليم الناجح",
    ...
    pushTitle: "العنوان",
    pushTitlePlaceholder: "أدخل عنوان الإشعار...",
    pushMessage: "الرسالة",
    pushMessagePlaceholder: "أدخل رسالة الإشعار...",
    ...
    actionUrlPlaceholder: "https://example.com/page",
    ...
    allowPromotionalDesc: "إرسال رسائل تسويقية وترويجية",
    enableQuietHours: "تفعيل ساعات الهدوء",
    enableQuietHoursDesc: "عدم إرسال إشعارات خلال ساعات محددة",
    ...
    success: "نجح",
    error: "خطأ",
    createSuccess: "تم إنشاء وإرسال الإشعار الفوري بنجاح!",
    createError: "فشل في إنشاء الإشعار الفوري. يرجى المحاولة مرة أخرى.",
    settingsUpdated: "تم تحديث إعدادات الإشعارات الفورية بنجاح!",
    settingsError: "فشل في تحديث الإعدادات. يرجى المحاولة مرة أخرى.",
