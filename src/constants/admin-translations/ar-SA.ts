...
export const adminTranslationsAR = {
  ...
  financial: {
    ...
    description: "إدارة المعاملات المالية وإيرادات المنصة",
    ...
    reference: "المرجع",
    bulkActionPlaceholder: "إجراء مجمع...",
    markAsCompleted: "تحديد كمكتملة",
    markAsFailed: "تحديد كفاشلة",
    markAsCancelled: "تحديد كملغاة",
    ...
    invoiceGenerated: "فاتورة مولدة",
    noTransactionsFound: "لم يتم العثور على معاملات",
    noTransactionsMatch: "لا توجد معاملات تطابق مرشحاتك الحالية",
    transactionDetails: "تفاصيل المعاملة",
    viewAndManageTransaction: "عرض وإدارة تفاصيل المعاملة",
    confirmBulkAction: "تأكيد الإجراء المجمع",
    applySelectedAction: "تطبيق الإجراء المحدد على {count} معاملة؟",
    applyAction: "تطبيق الإجراء",
    exportCompleted: "اكتمل التصدير",
    transactionsExported: "تم تصدير {count} معاملة إلى CSV",
    dataRefreshed: "تم تحديث البيانات",
    dataUpdated: "تم تحديث بيانات المعاملات المالية",
    transactionStatusUpdated: "تم تحديث حالة المعاملة إلى {status}",
    transactionDeleted: "تم حذف المعاملة بنجاح",
    transactionsUpdated: "تم تحديث {count} معاملة",
    transactionsDeleted: "تم حذف {count} معاملة",
    bulkActionFailed: "فشل الإجراء المجمع",
    fetchError: "فشل في جلب المعاملات",
    updateError: "فشل في تحديث حالة المعاملة",
    deleteError: "فشل في حذف المعاملة",
    refresh: "تحديث",
    export: "تصدير",
    transactionsCount: "المعاملات ({count})",
    selectAll: "تحديد الكل",
    transactionsSelected: "{count} معاملة محددة",
    notSpecified: "غير محدد",
    noReference: "لا يوجد مرجع",
    unknownUser: "مستخدم غير معروف",
    noDescription: "لا يوجد وصف",
    deleteTransaction: "حذف المعاملة",
    deleteConfirmation: "هل أنت متأكد من حذف هذه المعاملة؟ لا يمكن التراجع عن هذا الإجراء.",
    bulkDeleteConfirmation: "هل أنت متأكد من {action} {count} معاملة؟ لا يمكن التراجع عن هذا الإجراء."
  },
  ...
  email: {
    ...
    sentThisMonth: "مرسل هذا الشهر",
    openRate: "معدل الفتح",
    clickRate: "معدل النقر",
    allTime: "كل الأوقات",
    fromLastMonth: "+12% من الشهر الماضي",
    average: "المتوسط",
    noCampaignsYet: "لا توجد حملات بعد",
    createFirstCampaign: "أنشئ حملتك الإلكترونية الأولى للبدء",
    noTemplatesYet: "لا توجد قوالب بعد",
    createFirstTemplate: "أنشئ قالب بريدك الإلكتروني الأول للبدء",
    ...
    htmlContentPlaceholder: "أدخل محتوى قالب HTML هنا...",
    ...
    emailPerformanceTrends: "اتجاهات أداء البريد الإلكتروني",
    topPerformingCampaigns: "الحملات الأفضل أداءً",
    audienceEngagement: "تفاعل الجمهور",
    campaignPerformance: "أداء الحملة",
    performanceData: "بيانات الأداء ستكون متاحة بمجرد إرسال الحملات",
    topCampaigns: "الحملات الأفضل أداءً بناءً على معدلات الفتح والنقر",
    engagementMetrics: "مقاييس تفاعل الجمهور ورؤى التقسيم",
    sent: "مرسل",
    opened: "مفتوح",
    clicked: "تم النقر",
    scheduled: "مجدول",
  ...
  users: {
    ...
    // User Fields (removed duplicates)
