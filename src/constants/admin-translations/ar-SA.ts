...
export const adminTranslationsAR = {
  ...
  // إدارة الاشتراكات
  subscriptions: {
    fetchError: "فشل في جلب الاشتراكات",
    ...
    bulkUpdateSuccess: "تم تحديث الاشتراكات",
    bulkActionError: "فشل الإجراء المجمع",
    exportCompleted: "اكتمل التصدير",
    exportDescription: "تم تصدير الاشتراكات إلى CSV",
    dataRefreshed: "تم تحديث البيانات",
    dataUpdated: "تم تحديث بيانات الاشتراكات"
  },

  // إدارة الطلبات
  ordersManagement: {
    title: "إدارة الطلبات",
    description: "إدارة وتتبع جميع الطلبات عبر المنصة",
    ...
    pendingCount: "معلق",
    filtersActions: "المرشحات والإجراءات",
    searchPlaceholder: "البحث في الطلبات والعملاء والموردين...",
    filterByStatus: "تصفية حسب الحالة",
    allStatus: "جميع الحالات",
    refresh: "تحديث",
    export: "تصدير",
    orderSelected: "طلبات محددة",
    bulkActionPlaceholder: "اختر إجراءً مجمعاً...",
    confirmOrder: "تأكيد الطلب",
    markInProgress: "تحديد كقيد التنفيذ",
    markCompleted: "تحديد كمكتمل",
    cancelOrder: "إلغاء الطلب",
    deleteSelected: "حذف المحدد",
    applyBulkAction: "تطبيق الإجراء المجمع",
  ...
  expertConsultations: {
    ...
    deletedConsultationsCount: "تم حذف {count} استشارة بنجاح",
  ...
  requestsManagement: {
    title: "إدارة الطلبات",
    description: "مراجعة وإدارة جميع طلبات العملاء",
    fetchError: "فشل في تحميل الطلبات",
    approveSuccess: "تم الموافقة على الطلب بنجاح",
    ...
    searchPlaceholder: "البحث في الطلبات والعملاء والفئات...",
  ...
  offersManagement: {
    ...
    escalateError: "فشل في تصعيد المشكلة",
    ...
    filtersAndSearch: "المرشحات والبحث",
    searchPlaceholder: "البحث في العروض والموردين والطلبات...",
    ...
    lessThan10k: "< 10,000 ريال",
    between10k50k: "10,000 - 50,000 ريال",
    greaterThan50k: "> 50,000 ريال",
    refresh: "تحديث",
    ...
    pending: "معلق",
    loading: "جارٍ التحميل...",
    noOffersFound: "لم يتم العثور على عروض تطابق معاييرك"
  },
