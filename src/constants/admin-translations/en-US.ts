...
export const adminTranslationsEN = {
  ...
  pushNotifications: {
    ...
    pushTitle: "Title",
    pushTitlePlaceholder: "Enter notification title...",
    pushMessage: "Message",
    pushMessagePlaceholder: "Enter notification message...",
    ...
    allowPromotionalDesc: "Send marketing and promotional messages",
    enableQuietHours: "Enable Quiet Hours",
    enableQuietHoursDesc: "Don't send notifications during specified hours",
    ...
    success: "Success",
    error: "Error",
    createSuccess: "Push notification created and sent successfully!",
    createError: "Failed to create push notification. Please try again.",
    settingsUpdated: "Push notification settings updated successfully!",
