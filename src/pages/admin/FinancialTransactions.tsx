  ...
  const fetchTransactions = async () => {
    try {
      ...
      const mockTransactions: FinancialTransaction[] = [
        ...
        {
          id: '2',
          description: 'Commission - Project #1234',
          amount: 150.00,
          status: 'pending',
          type: 'commission',
      ...
      setStats({
        totalRevenue: total,
        monthlyRevenue: total * 0.8,
        averageTransaction: total / mockTransactions.length,
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Monitor revenue, track payments, and analyze financial performance</p>
          </div>
        </div>
