...
export const Landing = () => {
  ...
  return <div className="min-h-screen bg-background">
      <SmoothScroll />
      {/* Enhanced Navigation */}
      <header className="border-b bg-gradient-to-r from-primary via-accent to-lime backdrop-blur-sm sticky top-0 z-50">
      ...
      <section className="relative py-32 px-4 overflow-hidden bg-gradient-to-r from-primary via-accent to-lime">
